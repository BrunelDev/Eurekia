...
export const ClientFeedbackSection = () => {
  ...
  return (
    <section className="relative w-full h-[300px] sm:h-[400px] lg:min-h-[calc(100vh-172px)] bg-[linear-gradient(180deg,rgba(255,196,0,0.05)_0%,rgba(255,196,0,0.25)_100%),url(/etape1.jpg)] bg-cover bg-center bg-no-repeat animate-fade-in opacity-100 [--animation-delay:200ms] rounded-none">
