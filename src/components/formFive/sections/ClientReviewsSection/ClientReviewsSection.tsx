...
export const ClientReviewsSection = () => {
  ...
  return (
    <section className="relative w-full min-h-[400px] sm:min-h-[500px] lg:min-h-[calc(100vh-172px)] h-full bg-[linear-gradient(180deg,rgba(2,19,39,0)_0%,rgba(2,19,39,1)_100%),url(/etape4.jpg)] bg-cover bg-center bg-no-repeat animate-fade-in opacity-0 [--animation-delay:200ms] rounded-lg sm:rounded-none">
