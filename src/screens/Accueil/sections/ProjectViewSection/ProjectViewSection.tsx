      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <Card className="w-full max-w-[564px] h-[704px] rounded-[28px] overflow-hidden border-none shadow-none">
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between w-full">
                <div className="bg-[#fbf9eb] translate-y-3">
                  <CardHeader className="px-5 py-4 bg-white rounded-[0px_0px_28px_0px]">
                    <h2 className="text-3xl font-heading-h1 text-[#1e1e1e] text-[length:var(--heading-h1-font-size)] tracking-[var(--heading-h1-letter-spacing)] leading-[var(--heading-h1-line-height)] [font-style:var(--heading-h1-font-style)]">
                      EURÊKA INGENIERIE!
                    </h2>
                  </CardHeader>
                </div>
          ...
          <Card className="w-full h-full flex flex-col rounded-3xl overflow-hidden border-none shadow-none bg-[#f6f6f6]">
            <CardHeader className="p-6 sm:p-8 translate-y-3">
              <h2 className="text-3xl sm:text-4xl font-bold text-[#1e1e1e] text-[length:var(--heading-h1-font-size)] tracking-[var(--heading-h1-letter-spacing)] leading-[var(--heading-h1-line-height)] [font-style:var(--heading-h1-font-style)]">
                EURÊK'IA!
              </h2>
            </CardHeader>
